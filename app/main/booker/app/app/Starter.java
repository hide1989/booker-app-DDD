...
import booker.app.app.maroos.MaroosBackendApplication;
import booker.app.shared.infrastructure.cli.ConsoleCommand;
...
public class Starter {
    ...
    private static HashMap<String, Class<?>> applications() {
        ...
        applications.put("maroos", MaroosBackendApplication.class);
